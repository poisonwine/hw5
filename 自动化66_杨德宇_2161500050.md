...
&emsp;&emsp;两种滤波器不同截止频率的功率谱比如下表所示：

|滤波器类型        | 截至频率           | 功率谱比  |滤波器类型        | 截至频率           | 功率谱比  |
| ------------- |:-------------:| -----:| ------------- |:-------------:| -----:|
| butterworth      | 25 | 0.9323 |gauss|25|0.9537|
| butterworth      | 50      |   0.9696|gauss|50|0.9747|
| butterworth | 75      |    0.9824 |gauss|75|0.9824|
